...
JNIEXPORT jstring JNICALL
Java_com_fasttranslator_FastModelNative_nativeBenchmarkThreads(
    JNIEnv* env, jobject /*thiz*/) {
    std::string report = thread_bench::run();
    return env->NewStringUTF(report.c_str());
}

JNIEXPORT jstring JNICALL
Java_com_fasttranslator_FastModelNative_nativeBenchmarkVulkan(
    JNIEnv* env, jobject /*thiz*/) {
